...
inline std::string string_from_file(std::filesystem::path const & path, std::ios_base::openmode const mode = std::ios_base::in)
{
...
TEST_P(raptor_search, search)
{
    ...
    std::string actual = string_from_file("search.out");
