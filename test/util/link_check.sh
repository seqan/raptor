...
# -----------------------------------------------------------------------------------------------------
#
# Usage: link_check.sh <Raptor root directory>
...
if [[ $# -ne 1 ]]; then
    echo "Usage: link_check.sh <Raptor root directory>"
    exit 1
fi
...
if [[ ! -f $1/include/raptor/raptor.hpp ]]; then
    echo "The directory $1 does not seem to be the Raptor root directory."
    echo "Cannot find $1/include/raptor/raptor.hpp."
    exit 1
fi
