...
#include <functional> // for equal_to, invoke
#include <ranges>     // for iota_view, __fn, operator==, views, iota, size, vie...
...
#include <hibf/contrib/robin_hood.hpp>   // for hash, pair, unordered_map
